            ...
            try:
                ...
                if msg[:4] == "data":
                    ...
                    for i, v in self.connections.items():
                        if v == conn:
                            if i == "P1":
                                self.P1.ready = data["P1"][0]
                                self.P1.currentCard = tuple(data["P1"][1])
                            elif i == "P2":
                                self.P2.ready = data["P2"][0]
                    ...
                    if self.P1.ready and self.P2.ready:
                        ...
                        if roundWinner != "":
                            ...
                            self.P1.currentCard = DEFAULT_CARD
                            self.P1.ready = False
                            self.P2.currentCard = DEFAULT_CARD
                            self.P2.ready = False
